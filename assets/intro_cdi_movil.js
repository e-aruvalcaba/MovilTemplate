...
// stage content:
(lib.intro_cdi_movil = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(401,558.4,1,1,0,0,0,163.6,78.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(760.1,909.4,1014.3,207.9);
// library properties:
lib.properties = {
	width: 800,
	height: 1200,
